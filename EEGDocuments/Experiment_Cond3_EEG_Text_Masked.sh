#!/bin/bash
#=================================================================
# CONDITION 3: EEG-Text Alignment (Masked CE)
# Query: Subject A EEG → Document: Tokenized text of same sentence
# Loss: Masked CE — same-sentence batch duplicates excluded from softmax denominator
#=================================================================
...
#SBATCH --job-name=cond3_eeg_text_masked
#SBATCH --output=slurm-%j_cond3_eeg_text_masked.out
